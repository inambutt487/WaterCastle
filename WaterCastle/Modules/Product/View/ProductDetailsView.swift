...
//                HStack(spacing: 10) {
//                    ForEach(ProductData.allRows()) { product in
...
//            
//            HStack {
//                ForEach(ProductData.allRows().map { $0.size ?? "" }, id: \.self) { size in
//                    Button(action: {
//                        self.size = size
//                    }) {
//                        Text(size)
...
//            
//            HStack {
//                ForEach(ProductData.allRows().map { $0.color ?? "" }, id: \.self) { color in
//                    Button(action: {
//                        self.color = color
//                    }) {
//                        Circle()
...
//        ProductDetailsView(show: .constant(false), product: ProductData.allRows().first!)
//    }
//}
